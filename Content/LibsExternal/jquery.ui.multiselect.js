/*
 * **** This current version has been pulled from https://github.com/crdeutsch/multiselect ****
 * **** Last update to this library was on 1/11/2014 ****
 *
...
(function ($) {
    ...
    $.widget("ui.multiselect", {
        ...
        _create: function () {
            ...
            this.selectedActions = $('<div class="actions ui-widget-header ui-helper-clearfix"><span class="count">0 ' + (this.count == 1 ? $.ui.multiselect.locale.itemsCountSingular : $.ui.multiselect.locale.itemsCount) + '</span>' + (this.options.includeRemoveAll ? '<a class="remove-all">' + $.ui.multiselect.locale.removeAll + '</a>' : '<span>&nbsp;</span>') + '</div>').appendTo(this.selectedContainer);
            this.availableActions = $('<div class="actions ui-widget-header ui-helper-clearfix"><input type="text" class="search empty ui-widget-content ui-corner-all"/>' + (this.options.includeAddAll ? '<a class="add-all">' + $.ui.multiselect.locale.addAll + '</a>' : '<span>&nbsp;</span>') + '</div>').appendTo(this.availableContainer);
        ...
        _getOptionNode: function (option) {
            option = $(option);
            var node = $('<li class="ui-state-default ui-element" title="' + option.text() + '"><span class="ui-icon"/>' + option.text() + '<a class="action"><span class="ui-corner-all ui-icon"/></a></li>').hide();
